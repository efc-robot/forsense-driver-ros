...
void data_extraction(void)
{
    ...
    imu_msg.linear_acceleration.x = rxdata_union.AHRS_DATA_9axis.imu[0];
    imu_msg.linear_acceleration.y = -rxdata_union.AHRS_DATA_9axis.imu[1];
    imu_msg.linear_acceleration.z = -rxdata_union.AHRS_DATA_9axis.imu[2];

    imu_msg.angular_velocity.x = rxdata_union.AHRS_DATA_9axis.imu[3]*DEG_TO_RAD;
    imu_msg.angular_velocity.y = -rxdata_union.AHRS_DATA_9axis.imu[4]*DEG_TO_RAD;
    imu_msg.angular_velocity.z = -rxdata_union.AHRS_DATA_9axis.imu[5]*DEG_TO_RAD;

    mag_msg.magnetic_field.x = rxdata_union.AHRS_DATA_9axis.mag[0];
    mag_msg.magnetic_field.y = -rxdata_union.AHRS_DATA_9axis.mag[1];
    mag_msg.magnetic_field.z = -rxdata_union.AHRS_DATA_9axis.mag[2];
    ...
    imu_msg.orientation=tf::createQuaternionMsgFromRollPitchYaw(attitude[0]*DEG_TO_RAD,-attitude[1]*DEG_TO_RAD,
